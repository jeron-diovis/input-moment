...
module.exports = class InputMoment extends React.Component {
    ...
    return (
      <div className={cx("m-input-moment", {
        ...
        <div className="m-input-moment__options">
          {showTabs && (
            <button type="button"
                    className={cx('ion-calendar m-input-moment__btn m-input-moment__btn-options', { 'is-active': tab === 0 })}
          ...
          {showTabs && (
            <button type="button"
                    className={cx('ion-clock m-input-moment__btn m-input-moment__btn-options', { 'is-active': tab === 1 })}
